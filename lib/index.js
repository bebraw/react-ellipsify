...
module.exports = React.createClass({
    ...
    render() {
        ...
        var content = ellipsify(this.props);
        var more = <More key='more' more={this.props.more} moreClass={this.props.moreClass} onClick={this.show} />;

        return <div>{atFront? [content, more]: [more, content]}</div>;
    },
